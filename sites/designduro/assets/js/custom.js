(function($){
	...
	$(document).ready(function() {
		...
		var mapLocation = new google.maps.LatLng(-23.315183, -51.161571);
		...
		if ($mapis.length > 0) {
			...
			map.addMarker({
				...
				title: 'Rival',
				infoWindow: {
					content: '<p><strong>Design Duro</strong><br/>Rua Professor João Candido 350, <br/>P: 55 11 3500 7940<br/>Bauru / SP - Brasil</p>'
				}
			});
